...
os.mkdir(folder2+"Needle_db_2")
fileNeedleOut = open(folder2+"Needle_db_2/Needle_complete_db_table_v2.txt","w")
fileNeedleOut.write(alignheader)
fileAlignNeedleOut = open(folder2+"Needle_db_2/Needle_complete_db_align_v2.txt","w")
...
for files2 in fileList:
    ...
    # arquivo para consulta
        F_TempResultName = folder2+"temp_results/"+files2.replace("ortho_proteins.fa","")+"align_results.txt" 
        ...
        # repetir procedimento para score e ident
                ...
                if type(finalIndex) != str:
                        if AlignInfo["mm1"][finalIndex] in MmusAlignD.keys():
                                mm1List2 = []
                                mm1List2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["hsT1"]
                                mm1List2.append(hsT1)
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["hsT1"] = mm1List2
            
                                identRatioList2 = []
                                identRatioList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["ident_ratio"]
                                identRatioList2.append(float(AlignInfo["ident_ratio"][finalIndex]))                            
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["ident_ratio"] = identRatioList2
    
                                simRatioList2 = []
                                simRatioList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["sim_ratio"]
                                simRatioList2.append(float(AlignInfo["sim_ratio"][finalIndex]))
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["sim_ratio"] = simRatioList2
    
                                scoreList2 = []
                                scoreList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["score"]
                                scoreList2.append(AlignInfo["score"][finalIndex])
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["score"] = scoreList2

                                gapRatioList2 = []
                                gapRatioList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["gap_ratio"]
                                gapRatioList2.append(float(AlignInfo["gap_ratio"][finalIndex]))
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["gap_ratio"] = gapRatioList2
                                
                                alignSeqList2 = []
                                alignSeqList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["align_seq"]
                                alignSeqList2.append(AlignInfo["align_seq"][finalIndex])
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["align_seq"] = alignSeqList2
                
                                similarityList2 = []
                                similarityList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["similarity"]
                                similarityList2.append(AlignInfo["similarity"][finalIndex])
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["similarity"] = similarityList2

                                identityList2 = []
                                identityList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["identity"]
                                identityList2.append(AlignInfo["identity"][finalIndex])
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["identity"] = identityList2

                                gapsList2 = []
                                gapsList2 = MmusAlignD[AlignInfo["mm1"][finalIndex]]["gap"]
                                gapsList2.append(AlignInfo["gap"][finalIndex])
                                MmusAlignD[AlignInfo["mm1"][finalIndex]]["gap"] = gapsList2
