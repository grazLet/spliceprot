...
setwd("B:/Doutorado/PatternLab/Outputs_Certos_Maio/SpliceProt_Completo/")

#### lendo output PatternLab ####
splice_non_A <-read.table("PXD008720-spliceprot-COMPLETO-11052022-leticia/old/peptides-PXD008720-spliceprot-COMPLETO-11052022-old.txt", sep = "\t")
...
library(readxl)
Scans <- read_excel("PXD008720-spliceprot-COMPLETO-11052022-leticia/old/Scans-PXD008720-spliceprot-COMPLETO-11052022-old.xlsx", 
...
swiss <- read.table("PXD008720-swissprot-05052022-leticia/old/peptides-PXD008720-old.txt", sep = "\t")
...
Scans <- read_excel("PXD008720-swissprot-05052022-leticia/old/Scans-PXD008720-old.xlsx", 
                    col_types = c("numeric", "text", "text", 
                                  "text", "text", "text", "text", "text", 
                                  "numeric", "numeric", "text", "numeric", 
                                  "numeric", "numeric", "text", "text", 
...
write.csv2(redudantes_spliceANDswiss, file = "PXD009021-spliceprot-COMPLETO-SEMNMD-leticia-14042022/redundantes-SPLICE-COMPLETO-swiss.csv")

#### encontrando as exclusivas de cada banco

df = spliceprot %>% anti_join(swissprot,by="Sequence") 

exclusivas_swissprot = swissprot %>% anti_join(spliceprot,by="Sequence") #exclusivas swiss

write.csv2(exclusivas_swissprot, file = "PXD009021-spliceprot-COMPLETO-SEMNMD-leticia-14042022/exclusivas_swissprot-SPLICEPROT-COMPLETO.csv")

exclusivas_spliceprot <- df

write.csv2(exclusivas_spliceprot, file = "PXD009021-spliceprot-COMPLETO-SEMNMD-leticia-14042022/exclusivas_spliceprot-SPLICE-COMPLETO-swiss.csv")

#### filtrando as exclusivas do spliceprot completo contra o banco completo do swissprot ####

swiss_banco_completo = Biostrings::readAAStringSet("B:/Doutorado/fastas/uniprot-created_[19860101+TO+20211117]+AND+reviewed_yes++AND+organism_--.fasta")
...
write.csv(proteotipicos_spliceprot,"PXD008720-spliceprot-COMPLETO-11052022-leticia/old/PXD008720-proteotipicos-spliceprot.csv")

# 123 em comum entre os meus resultados e os do Alan
#repetidas <- intersect(proteotipicos$Sequence,emorySpliceCOMPLETO$peptide)

#as 6 diferentes entre os meus resultados e os do Alan

#unicas = proteotipicos %>% anti_join(emorySpliceCOMPLETO,by="Sequence")
#write.csv(unicas,"unicos-proteotipicos-2022-emory-AD-SPLICE-COMPLETO.csv")
...
proteotipicos_spliceprot_final <- read_delim("PXD008720-spliceprot-COMPLETO-11052022-leticia/old/PXD008720-proteotipicos-spliceprot-final.csv", 
...
#### openprot ####
open <- read.table("PXD008720-openprot-05052022-leticia/old/peptides-PXD008720-old.txt", sep = "\t")
...
Scans <- read_excel("PXD008720-openprot-05052022-leticia/old/Scans-PXD008720-old.xlsx", 
                    col_types = c("numeric", "text", "text", 
                                  "text", "text", "text", "text", "text", 
                                  "numeric", "numeric", "text", "numeric", 
                                  "numeric", "numeric", "text", "text", 
...
write.csv(proteotipicos_openprot,"PXD008720-openprot-05052022-leticia/old/PXD008720-proteotipicos-openprot.csv")
...
proteotipicos_openprot_final <- read_delim("PXD008720-openprot-05052022-leticia/old/PXD008720-proteotipicos-openprot-final.csv", 
                                           delim = "\t", escape_double = FALSE, 
                                           col_names = FALSE, trim_ws = TRUE)
#mudando o nome das colunas do arquivo
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD008720/human-OPENPROT-swiss.png',
  output=TRUE,
  main = "HUMAN OPENPROT vs SWISSPROT",
  main.cex = 0.1,
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD008720/human-SPLICE-COMPLETO-swiss.png',
  output=TRUE,
  main = "HUMAN-SPLICE-COMPLETO vs SWISSPROT",
  main.cex = 0.2,
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD008720/human-SPLICE-COMPLETO-VS-OPENPROT.png',
  output=TRUE,
...
venn.diagram(
  ...
  category.names = c("Splice" , "Open"),
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD008720/human-SPLICE-COMPLETO-VS-OPENPROT-filtrofinal.png',
  output=TRUE,
  main = "HUMAN-SPLICE-COMPLETO vs OPENPROT FILTRO FINAL",
  main.cex = 0.1,
...
venn.diagram(
  ...
  category.names = c("Splice" , "Swiss"),
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD008720/human-PROTEOTIPICOS-SPLICE-COMPLETO-swiss.png',
  output=TRUE,
  main = "HUMAN-PROTEOTIPICOS-SPLICE-COMPLETO vs SWISSPROT",
  main.cex = 0.2,
