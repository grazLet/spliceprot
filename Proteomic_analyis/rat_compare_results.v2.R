...
splice_non_A <-read.table("PXD016793-spliceprotCOMPLETO-SEMNMD-11052022/peptides-PXD016793-spliceprotCOMPLETO-SEMNMD-11052022.txt", sep = "\t")
...
Scans <- read_excel("PXD016793-spliceprotCOMPLETO-SEMNMD-11052022/Scans-PXD016793-spliceprotCOMPLETO-SEMNMD-11052022.xlsx", 
...
swiss <- read.table("PXD016793-swiss-leticia-13042022/peptides-PXD016793-swiss-leticia-13042022.txt", sep = "\t")
...
Scans <- read_excel("PXD016793-swiss-leticia-13042022/Scans-PXD016793-swiss-leticia-13042022.xlsx", 
                    col_types = c("numeric", "text", "text", 
                                  "text", "text", "text", "text", "text", 
                                  "numeric", "numeric", "text", "text", 
...
write.csv2(redudantes_spliceANDswiss, file = "PXD016793-redundantes-SPLICE-COMPLETO-swiss.csv")
...
write.csv2(exclusivas_swissprot, file = "PXD016793-exclusivas_swissprot-SPLICEPROT-COMPLETO.csv")

exclusivas_spliceprot <- df

write.csv2(exclusivas_spliceprot, file = "PXD016793-exclusivas_spliceprot-SPLICE-COMPLETO-swiss.csv")

#### filtrando as exclusivas do spliceprot completo contra o banco completo do swissprot ####

swiss_banco_completo = Biostrings::readAAStringSet("B:/Doutorado/fastas/uniprot-created_[19860101+TO+20211117]+organism__rattus+norvegicus_---.fasta")
...
write.csv(proteotipicos_spliceprot,"PXD016793-spliceprotCOMPLETO-SEMNMD-11052022/proteotipicos-PXD016793-SPLICE-COMPLETO.csv")

#sair do R e rodar este script no último output 
#perl vin_filter_substrings_proteotipicos.pl proteotipicos-PXD016793-SPLICE-COMPLETO.csv > proteotipicos-PXD016793-SPLICE-COMPLETO-final.csv

#abrindo o novo arquivo de proteotípicos exclusivos do SpliceProt Completo
proteotipicos_spliceprot_final <- read_delim("PXD016793-spliceprotCOMPLETO-SEMNMD-11052022/proteotipicos-PXD016793-SPLICE-COMPLETO-final.csv", 
...
#### openprot ####
open <- read.table("../Outputs_Certos_Abril_2022/PXD016793-openprot-leticia-16042022/peptides-PXD016793-openprot-leticia-16042022.txt", sep = "\t")
...
Scans <- read_excel("../Outputs_Certos_Abril_2022/PXD016793-openprot-leticia-16042022/Scans-PXD016793-openprot-leticia-16042022.xlsx", 
                    col_types = c("numeric", "text", "text", 
                                  "text", "text", "text", "text", "text", 
                                  "numeric", "numeric", "text", "text", 
                                  "numeric", "numeric", "numeric", 
...
write.csv2(exclusivas_swissprot_open, file = "PXD016793-exclusivas_swissprot-OPENPROT.csv")

exclusivas_openprot <- df

write.csv2(exclusivas_openprot, file = "PXD016793-exclusivas_openprot-swiss.csv")
...
write.csv(proteotipicos_openprot,"proteotipicos-PXD016793-openprot.csv")
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD016793/rat-OPENPROT-swiss.png',
  output=TRUE,
  main = "RAT OPENPROT vs SWISSPROT",
  main.cex = 0.1,
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD016793/rat-SPLICE-COMPLETO-swiss.png',
  output=TRUE,
  main = "RAT-SPLICE-COMPLETO vs SWISSPROT",
  main.cex = 0.2,
...
venn.diagram(
  ...
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD016793/RAT-SPLICE-COMPLETO-VS-OPENPROT.png',
  output=TRUE,
  main = "RAT-SPLICE-COMPLETO vs OPENPROT",
  main.cex = 0.2,
...
venn.diagram(
  x = list(proteotipicos_spliceprot_final$Sequence, proteotipicos_openprot$Sequence),
  category.names = c("Splice" , "Open"),
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD016793/RAT-SPLICE-COMPLETO-VS-OPENPROT-filtrofinal.png',
  output=TRUE,
  main = "RAT-SPLICE-COMPLETO vs OPENPROT FILTRO FINAL",
  main.cex = 0.1,
...
venn.diagram(
  ...
  category.names = c("Splice" , "Swiss"),
  #category.names = c("" , ""),
  filename = 'B:/Doutorado/PatternLab/Outputs_Certos_Maio/Figuras/PXD016793/rat-PROTEOTIPICOS-SPLICE-COMPLETO-swiss.png',
  output=TRUE,
  main = "RAT-PROTEOTIPICOS-SPLICE-COMPLETO vs SWISSPROT",
  main.cex = 0.2,
